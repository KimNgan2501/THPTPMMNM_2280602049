...
<body>
    <h1>Sửa sản phẩm</h1>
    <form method="POST" action="/HoatKimNgan/Product/edit/<?php echo $product->getID();
    ?>">
    ...
    <a button type="button" href="/HoatKimNgan/Product/list" class="btn btn-danger">Quay lại danh sách sản phẩm</a>
</body>
