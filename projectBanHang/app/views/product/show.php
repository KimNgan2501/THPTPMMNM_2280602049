                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if ($product->image): ?>
                            <img src="/projectBanHang/<?php echo
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4">
                            <a href="/projectBanHang/Product/addToCart/<?php echo
                                                                    $product->id; ?>"
                                class="btn btn-success px-4">➕ Thêm vào giỏ hàng</a>
                            <a href="/projectBanHang/Product/list" class="btn btnsecondary px-4 ml-2">Quay lại danh sách</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
